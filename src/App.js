...
import { applyNumber, changeOperation, clearDisplay, memoryAdd, memoryClear, memoryMr } from './actions/index'
  ...
  return (
    <div className="App">
      <nav className="navbar navbar-dark bg-dark">
        <a className="navbar-brand" href="#"><img width="40px" src="./Lambda-Logo-Red.png" />
